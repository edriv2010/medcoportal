...
import Add from './ModalSolution/add';
import Filter from './ModalSolution/filter';
import Approve from './ModalSolution/approve';
import Preview from './ModalSolution/preview';
...
import sampleData from '../../Commons/jsonFile/sample/preworkSolution.json';
                ...
                formatter: (cellContent, row) => {
                    return (
                        <div>
                            ...
                            <span className="btnInTable">
                                <Button className="btn-vine btn-brand btn-sm icon" id="btn3" onClick={(e) => this.handleAction(e, row, 'approve')}><i className="icon-file-check"> </i></Button>
                        ...
                        <Col xs="12" md="12">
                            <Card style={{marginBottom:'0'}}>
                                <CardBody>
                                    <Row>
                                        <Col md="12">
                                            <div className="titleFilter"><i className="icon-stack"></i> Collected and validated technology</div>
