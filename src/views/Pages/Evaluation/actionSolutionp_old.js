...
class ActionSolutionp extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            datas: [
                { id: 1, dt1:'Life Cycle Cost',sc1:'',sc2:'',sc3:'',sc4:'',sc5:'',sc6:'',sc7:'',dt2:17},
                { id: 2, dt1:'Complexity of implementation',sc1:'',sc2:'',sc3:'',sc4:'',sc5:'',sc6:'',sc7:'',dt2:23},
                { id: 3, dt1:'Complexity of Operation',sc1:'',sc2:'',sc3:'',sc4:'',sc5:'',sc6:'',sc7:'',dt2:6},
                { id: 4, dt1:'Benfits/ Monetization',sc1:'',sc2:'',sc3:'',sc4:'',sc5:'',sc6:'',sc7:'',dt2:10},
                { id: 5, dt1:'Local Content Amount (TKDN)',sc1:'',sc2:'',sc3:'',sc4:'',sc5:'',sc6:'',sc7:'',dt2:8}
            ],
                                        ...
                                        <Col md="12">
                                            ...
                                            <div className="customBody">
                                                ...
                                                <div style={{marginTop:'10px'}}>
                                                    ...
                                                    <Button className="btn-dropbox btn-brand btn-sm" onClick={() => {this.props.history.push('/qualification/solution')}}><i className="icon-undo2"> </i><span>Back</span></Button>
                                                </div>
                                            </div>
                                        </Col>
                                    </Row>
