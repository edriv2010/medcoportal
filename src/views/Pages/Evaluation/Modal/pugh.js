...
class Pugh extends Component {
    ...
    handlePugh = (e) => {
        ...
        const dataFooter = {
            ...
            sn3: this.state.sn3,
            sn4: this.state.sn4,
            colorsn1: this.state.colorsn1,
            colorsn2: this.state.colorsn2,
            colorsn3: this.state.colorsn3,
            colorsn4: this.state.colorsn4,
        }
        if(this.props.passData.data[0].id){
            const id = this.props.passData.data[0].id;
            this.props.btnSubmitPugh(e, id, data, dataFooter);
        }else{
            Swal.fire({
                title: 'Failed Submit Data!',
                icon: 'warning',
                text: 'Please Assign Pugh!',
    ...
    render() {
        ...
        return (
            <Modal isOpen={this.props.modalPugh} toggle={this.handleClick} className="modal-lg full-screen">
                <ModalHeader toggle={this.handleClick}>Form Pugh Matrix</ModalHeader>
                <ModalBody>
                    <Nav tabs>
                        <NavItem>
                            <NavLink
                ...
                <ModalFooter>
                    <Button className="btn-vine btn-brand btn-sm" onClick={(e) => this.handlePugh(e)}><i className="icon-checkmark4"> </i><span>Submit</span></Button>
