                    ...
                    <div>
                        <Card>
                            <CardBody className="customBox">
                                ...
                                <div className="cbbtn1"><Button className="btn-vine btn-brand btn-sm" onClick={() => {this.props.history.push({pathname: '/qualification/case/actiona', id: row.id})}}><i className="icon-file-text2"> A</i></Button></div>
                                <div className="cbbtn2"><Button className="btn-vine btn-brand btn-sm" onClick={() => {this.props.history.push({pathname: '/qualification/case/actionp', id: row.id})}}><i className="icon-file-text2"> P</i></Button></div>
                        ...
                        <Col xs="12" md="12">
                            <Card>
                                <CardBody>
                                    <Row>
                                        <Col md="12">
                                            <div className="titleFilter"><i className="icon-stack"></i> Evaluate and select solution</div>
                                            <div style={{float:'left'}}>
                                                <div style={{float:'left'}}><span style={{fontSize:'24px'}}><b style={{color:'#134A71'}}>2</b> Case |</span></div>
